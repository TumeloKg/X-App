<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <!-- drawer content -->
      <q-input placeholder="Search X" class="q-ma-md" outlined rounded dense>
      ...
      <q-list separator padding>
        ...
        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label class="text-grey" overline>Food</q-item-label>
            <q-item-label class="text-weight-bold">I Love to eat!</q-item-label>
            <q-item-label caption
              >Secondary line text. Lorem ipsum dolor sit amet, consectetur
              adipiscit elit.</q-item-label
            >
        ...
        <q-item class="q-pa-md">
          <q-item-section>
            <q-item-label class="text-grey" overline>Design</q-item-label>
            <q-item-label class="text-weight-bold"
              >Something amazing happened!</q-item-label
            >
            <q-item-label caption
